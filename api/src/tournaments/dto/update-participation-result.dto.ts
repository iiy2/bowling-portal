...
export class UpdateParticipationResultDto {
  ...
  @ApiProperty({
    ...
    description:
      'Array of individual game scores (minimum 6 games for qualification)',
    required: false,
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiProperty({
    example: 1250,
    description: 'Total score (sum of all game scores)',
    required: false,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiProperty({
    example: 150,
    description: 'Rating points earned',
    required: false,
  })
  @IsOptional()
  @IsNumber()
